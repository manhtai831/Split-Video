(function () {
  ...
  function initTrimAudioJobsPanel() {
    cacheElements();
    JobUI.init({
      modals: {
  ...
  function cacheElements() {
    els.tableBody = $("trimAudioJobsTableBody");
    els.cardList = $("trimAudioJobsCardList");
    els.empty = $("trimAudioJobsEmpty");
    els.tableWrap = $("trimAudioJobsTableWrap");
    els.skeleton = $("trimAudioJobsSkeleton");
    els.pagination = $("trimAudioJobsPagination");
    els.range = $("trimAudioJobsRange");
    els.pageInfo = $("trimAudioJobsPageInfo");
    els.pagePrev = $("trimAudioJobsPagePrev");
    els.pageNext = $("trimAudioJobsPageNext");
  }
  ...
  function loadJobs() {
    ...
    JobUI.fetchJobs({ type: "trim_audio", limit: PAGE_SIZE, page: state.page })
      .then(function (data) {
  ...
  window.initTrimAudioJobsPanel = initTrimAudioJobsPanel;
})();
