(function () {
  ...
  function initExtractAudioJobsPanel() {
    cacheElements();
    JobUI.init({
      modals: {
  ...
  function cacheElements() {
    els.tableBody = $("extractAudioJobsTableBody");
    els.cardList = $("extractAudioJobsCardList");
    els.empty = $("extractAudioJobsEmpty");
    els.tableWrap = $("extractAudioJobsTableWrap");
    els.skeleton = $("extractAudioJobsSkeleton");
    els.pagination = $("extractAudioJobsPagination");
    els.range = $("extractAudioJobsRange");
    els.pageInfo = $("extractAudioJobsPageInfo");
    els.pagePrev = $("extractAudioJobsPagePrev");
    els.pageNext = $("extractAudioJobsPageNext");
  }
  ...
  function loadJobs() {
    ...
    JobUI.fetchJobs({ type: "extract_audio", limit: PAGE_SIZE, page: state.page })
      .then(function (data) {
  ...
  window.initExtractAudioJobsPanel = initExtractAudioJobsPanel;
})();
