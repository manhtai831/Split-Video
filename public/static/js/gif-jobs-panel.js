(function () {
  ...
  function cacheElements() {
    els.tableBody = $("gifJobsTableBody");
    els.cardList = $("gifJobsCardList");
    els.empty = $("gifJobsEmpty");
    els.tableWrap = $("gifJobsTableWrap");
    els.skeleton = $("gifJobsSkeleton");
    els.pagination = $("gifJobsPagination");
    els.range = $("gifJobsRange");
    els.pageInfo = $("gifJobsPageInfo");
    els.pagePrev = $("gifJobsPagePrev");
    els.pageNext = $("gifJobsPageNext");
  }
  ...
  function loadJobs() {
    ...
    JobUI.fetchJobs({ type: "gif", limit: PAGE_SIZE, page: state.page })
      .then(function (data) {
  ...
  window.initGifJobsPanel = initGifJobsPanel;
})();
