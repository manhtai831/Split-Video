(function () {
  ...
  function initMergeAudioJobsPanel() {
    cacheElements();
    JobUI.init({
      modals: {
  ...
  function cacheElements() {
    els.tableBody = $("mergeAudioJobsTableBody");
    els.cardList = $("mergeAudioJobsCardList");
    els.empty = $("mergeAudioJobsEmpty");
    els.tableWrap = $("mergeAudioJobsTableWrap");
    els.skeleton = $("mergeAudioJobsSkeleton");
    els.pagination = $("mergeAudioJobsPagination");
    els.range = $("mergeAudioJobsRange");
    els.pageInfo = $("mergeAudioJobsPageInfo");
    els.pagePrev = $("mergeAudioJobsPagePrev");
    els.pageNext = $("mergeAudioJobsPageNext");
  }
  ...
  function loadJobs() {
    ...
    JobUI.fetchJobs({ type: "merge_audio", limit: PAGE_SIZE, page: state.page })
      .then(function (data) {
  ...
  window.initMergeAudioJobsPanel = initMergeAudioJobsPanel;
})();
